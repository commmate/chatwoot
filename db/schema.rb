...
ActiveRecord::Schema[7.1].define(version: 2025_12_02_140000) do
  ...
  create_table "pipelines", force: :cascade do |t|
    ...
    t.index ["custom_attribute_definition_id"], name: "index_pipelines_on_custom_attribute_definition_id"
  end
