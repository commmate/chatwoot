class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'evolution_api' => %w[EVOLUTION_API_ENABLED EVOLUTION_API_URL EVOLUTION_API_KEY],
      'resend' => %w[RESEND_ENABLED RESEND_MASTER_API_KEY],
      'sftp_campaigns' => %w[
        SFTP_CAMPAIGNS_ENABLED SFTP_CAMPAIGNS_HOST SFTP_CAMPAIGNS_PORT
        SFTP_CAMPAIGNS_USERNAME SFTP_CAMPAIGNS_PRIVATE_KEY SFTP_CAMPAIGNS_PASSWORD SFTP_CAMPAIGNS_REMOTE_PATH
      ],
