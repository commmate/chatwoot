...
class EvolutionAPI extends ApiClient {
  ...
  // Create a new Evolution-backed inbox
  ...
  getTemplates(inboxId) {
    return axios.get(`${this.url}/inboxes/${inboxId}/templates`);
  }

  createTemplate(inboxId, templateData) {
    return axios.post(`${this.url}/inboxes/${inboxId}/templates`, {
      template: templateData,
    });
  }

  updateTemplate(inboxId, templateId, templateData) {
    return axios.patch(`${this.url}/inboxes/${inboxId}/templates/${templateId}`, {
      template: templateData,
    });
  }

  deleteTemplate(inboxId, templateName, hsmId = null) {
    return axios.delete(`${this.url}/inboxes/${inboxId}/templates`, {
      params: { name: templateName, hsm_id: hsmId },
    });
  }
}
